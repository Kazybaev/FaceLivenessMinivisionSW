...
class Settings:
    ...
    real_threshold: float = 0.64
    spoof_threshold: float = 0.68
    minifas_primary_threshold: float = 0.68
    minifas_support_threshold: float = 0.56
    minifas_family_threshold: float = 0.60
    ...
    assisted_real_threshold: float = 0.66
    assisted_minifas_primary_threshold: float = 0.62
    assisted_minifas_support_threshold: float = 0.50
    assisted_minifas_family_threshold: float = 0.56
    assisted_deeppixbis_family_threshold: float = 0.68
    assisted_deeppixbis_max_spoof_threshold: float = 0.40
    assisted_temporal_live_threshold: float = 0.55
    assisted_temporal_rigid_max: float = 0.45
    dominant_primary_real_threshold: float = 0.68
    dominant_primary_minifas_threshold: float = 0.88
    dominant_primary_family_threshold: float = 0.60
    dominant_primary_deeppixbis_family_threshold: float = 0.72
    dominant_primary_deeppixbis_max_spoof_threshold: float = 0.35
    dominant_primary_temporal_live_threshold: float = 0.55
    dominant_primary_temporal_rigid_max: float = 0.50

    minifas_only_primary_threshold: float = 0.66
    minifas_only_support_threshold: float = 0.56
    minifas_only_family_threshold: float = 0.60
    minifas_only_real_threshold: float = 0.62
    minifas_only_temporal_live_threshold: float = 0.34
    ...
    landmark_quick_live_threshold: float = 0.58
    landmark_support_live_threshold: float = 0.50
    landmark_real_rigid_max: float = 0.74
    ...
    def from_env(cls) -> Settings:
        ...
        return cls(
            ...
            real_threshold=float(os.getenv("REAL_THRESHOLD", "0.64")),
            spoof_threshold=float(os.getenv("SPOOF_THRESHOLD", "0.68")),
            minifas_primary_threshold=float(os.getenv("MINIFAS_PRIMARY_THRESHOLD", "0.68")),
            minifas_support_threshold=float(os.getenv("MINIFAS_SUPPORT_THRESHOLD", "0.56")),
            minifas_family_threshold=float(os.getenv("MINIFAS_FAMILY_THRESHOLD", "0.60")),
            ...
            assisted_real_threshold=float(os.getenv("ASSISTED_REAL_THRESHOLD", "0.66")),
            assisted_minifas_primary_threshold=float(os.getenv("ASSISTED_MINIFAS_PRIMARY_THRESHOLD", "0.62")),
            assisted_minifas_support_threshold=float(os.getenv("ASSISTED_MINIFAS_SUPPORT_THRESHOLD", "0.50")),
            assisted_minifas_family_threshold=float(os.getenv("ASSISTED_MINIFAS_FAMILY_THRESHOLD", "0.56")),
            ...
            assisted_temporal_live_threshold=float(os.getenv("ASSISTED_TEMPORAL_LIVE_THRESHOLD", "0.55")),
            assisted_temporal_rigid_max=float(os.getenv("ASSISTED_TEMPORAL_RIGID_MAX", "0.45")),
            dominant_primary_real_threshold=float(os.getenv("DOMINANT_PRIMARY_REAL_THRESHOLD", "0.68")),
            dominant_primary_minifas_threshold=float(os.getenv("DOMINANT_PRIMARY_MINIFAS_THRESHOLD", "0.88")),
            dominant_primary_family_threshold=float(os.getenv("DOMINANT_PRIMARY_FAMILY_THRESHOLD", "0.60")),
            dominant_primary_deeppixbis_family_threshold=float(os.getenv("DOMINANT_PRIMARY_DEEPIXBIS_FAMILY_THRESHOLD", "0.72")),
            dominant_primary_deeppixbis_max_spoof_threshold=float(os.getenv("DOMINANT_PRIMARY_DEEPIXBIS_MAX_SPOOF_THRESHOLD", "0.35")),
            dominant_primary_temporal_live_threshold=float(os.getenv("DOMINANT_PRIMARY_TEMPORAL_LIVE_THRESHOLD", "0.55")),
            dominant_primary_temporal_rigid_max=float(os.getenv("DOMINANT_PRIMARY_TEMPORAL_RIGID_MAX", "0.50")),
            minifas_only_primary_threshold=float(os.getenv("MINIFAS_ONLY_PRIMARY_THRESHOLD", "0.66")),
            minifas_only_support_threshold=float(os.getenv("MINIFAS_ONLY_SUPPORT_THRESHOLD", "0.56")),
            minifas_only_family_threshold=float(os.getenv("MINIFAS_ONLY_FAMILY_THRESHOLD", "0.60")),
            minifas_only_real_threshold=float(os.getenv("MINIFAS_ONLY_REAL_THRESHOLD", "0.62")),
            minifas_only_temporal_live_threshold=float(os.getenv("MINIFAS_ONLY_TEMPORAL_LIVE_THRESHOLD", "0.34")),
            ...
            landmark_quick_live_threshold=float(os.getenv("LANDMARK_QUICK_LIVE_THRESHOLD", "0.58")),
            landmark_support_live_threshold=float(os.getenv("LANDMARK_SUPPORT_LIVE_THRESHOLD", "0.50")),
            landmark_real_rigid_max=float(os.getenv("LANDMARK_REAL_RIGID_MAX", "0.74")),
